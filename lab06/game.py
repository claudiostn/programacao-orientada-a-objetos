...
class Game:
  ...
  def __createRooms(self):
    ...
    lobby = Room("in the lobby")
    classroom = Room("in the classroom")

    # initialise room exits
    outside.setExits(None, theatre, lab, pub, lobby, None)
    ...
    lobby.setExits(None, classroom, None, None, None, outside)
    classroom.setExits(None, None, None, lobby, None, None)
